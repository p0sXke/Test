        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    BookSeats = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BookedFlights_AspNetUsers_UserProfileId",
                        column: x => x.UserProfileId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookedFlights_BookingStatuses_BookingStatusId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookedFlights_BookingStatusId",
                table: "BookedFlights",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookedFlights_UserProfileId",
                table: "BookedFlights",
